...
import com.website.exception.AppException;
import com.website.model.Role;
import com.website.model.RoleName;
import com.website.model.User;
import com.website.payload.ApiResponse;
import com.website.payload.JwtAuthenticationResponse;
import com.website.payload.LoginRequest;
import com.website.payload.SignUpRequest;
...
public class AuthController {
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody SignUpRequest signUpRequest) {
        ...
        User user = new User(signUpRequest.getFirst_name(), signUpRequest.getLast_name(), signUpRequest.getUsername(), signUpRequest.getEmail(), 
        					 signUpRequest.getNational_id(), signUpRequest.getBirthday(), signUpRequest.getGender(), signUpRequest.getPassword());
